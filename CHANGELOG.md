...
- Updated naming of inbox zero celebration to inbox zero streak
- Removed WIP flag from overlay setting
- Added logic to only show the streak overlay once per day
